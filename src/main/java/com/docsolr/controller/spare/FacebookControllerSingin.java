...
import com.docsolr.controller.FacebookController;
import com.docsolr.service.FacebookUtil;
import com.docsolr.service.OAuthServiceProvider;

public class FacebookControllerSingin<FacebookApi> extends ProviderSignInController {
	...
	public FacebookControllerSingin(ConnectionFactoryLocator connectionFactoryLocator,
			UsersConnectionRepository usersConnectionRepository, SignInAdapter signInAdapter) {
		super(connectionFactoryLocator, usersConnectionRepository, new FacebookSignInAdapter());
		// TODO Auto-generated constructor stub
	}
	...
	public synchronized RedirectView connectionStatusRedirect(String providerId, NativeWebRequest request) {
		...
		try {
			...
			User facebookProfile = template.userOperations()
					.getUserProfile();
			connectionRepository.updateConnection(primaryConnection);
		} catch (Exception e) {
			e.printStackTrace();
		}
			// String userId =
