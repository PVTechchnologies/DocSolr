...
<head>
  ...
  <meta name="description" content="Angular Bootstrap Dashboard"/>
	...
	<script>
	var contextroot = "/docsolr";//"${contextroot}";
	</script>  	
    ...
    <link href="css/angularjs-toaster/toaster.min.css" rel="stylesheet" />
...
<body ng-app="app" class="hold-transition sidebar-mini {{theme}} {{layout}}">
    ...
    <script src="plugins/owl-carousel/owl.carousel.min.js"></script>
 	<script src="plugins/angularUtils-pagination/dirPagination.js"></script>
 	<script src="plugins/vendors/ng-dialog/ngDialog.js"></script>
